    ...
    def __init__(self,
        ...
        with open(split_path) as file:
            for line in file:
                ...
                rgb_image_file_path = path.replace('***', 'crop')
                rgb_image_file_path = rgb_image_file_path.replace('???', 'rgb')
                depth_image_file_path = path.replace('***', 'depthcrop')
                depth_image_file_path = depth_image_file_path.replace('???', 'surfnorm')
